...
export const Receipt = () => (
  <html lang="ja" itemscope itemtype="http://schema.org/WebPage">
    <head>
      ...
      <link rel="shortcut icon" href="./data/507/img/favicon.ico" />
      <script
        async
...
gtag('config', 'G-K1X5L7LJ8F');`}
      ...
      <link
        rel="stylesheet"
        type="text/css"
        href="./src/page/css/base.css.php?SN=507&LG=1&DD=69f6dda220b5d"
      />
      <link
        rel="stylesheet"
        type="text/css"
        href="./src/page/css/receipt.css?DD=69f6dda220b5e"
      />
      <link
        rel="stylesheet"
        type="text/css"
        href="./data/common/1/custom.css?DD=69f6dda220b6a"
      />
    ...
    <body>
      <div class="off-canvas-wrap">
        <div class="inner-wrap portrait">
          <form
            ...
            method="post"
          >
            <input type="hidden" id="proc" name="proc" value="receipt" />
            ...
            <input type="hidden" id="shop-id" value="507" />
            <input type="hidden" id="table-no" value="24" />
            ...
            <div id="body-section">
              ...
              <div>
                <img
                  class="logo"
                  src="./data/507/img/logo-mini.png"
                  alt="イタリアンワイン＆カフェレストラン サイゼリヤ"
                />
                <div class="barcode">
                  <img
                    src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMoAAAAeAgMAAAAQpGkCAAAACVBMVEWAgIAAAAD///8+paC1AAAAAXRSTlMAQObYZgAAAAlwSFlzAAAOxAAADsQBlSsOGwAAADlJREFUOI3ty7ENADAMAkEv6cbTpfmGKUOiTBHRGIF8JWA0aui58RoIeaHPHVf5wbEqJiYmJuZbswHFoDdsS37TkwAAAABJRU5ErkJggg=="
                    alt=""
                  />
                  <p>503050760769</p>
                </div>
      ...
      <script
        type="text/javascript"
        src="./src/page/js/base.js.php?JS=receipt.js.php&SN=507&LG=1&DD=69f6dda220d2f"
      ></script>
    </body>
  </html>
)
